// services/stellar.server.ts
import 'server-only'; // This will prevent this module from being used on the client

// Use require instead of import for better compatibility with Node.js modules
// @ts-ignore
 ...
 * This service must be used only on the server side (API routes)
 */
